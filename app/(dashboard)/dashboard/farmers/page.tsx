...
export default function FarmersPage() {
  ...
  const [selectedFarmer, setSelectedFarmer] = useState<FarmerWithDetails | null>(null);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1">Manage registered farmers and their farms</p>
        </div>
      </div>
            ...
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {selectedFarmer.farm_profiles.map((farm) => (
                  <Card key={farm.id} className="border-2 hover:border-emerald-200 transition-colors">
